...
%MH hier Diagramm einfügen über die Übereinstimmung der drei Ziele? Sozusagen Venn-Diagramm mit GitHub im Schnittpunkt?
	...
	% Inhaltlich-fachbezogene Ziele:
	% Fachliche Kompetenz
	% Einführung in ausgewählte sozialwissenschaftliche Theorien und deren Anwendung auf die jüngere Geschichte und das politische System der BRD. GPC verbindet eine politikwissenschaftlich-orientierte Landeskunde der BRD (etwa: Shoah, politische Ordnung, Wohlfahrtsstaat) und ausgewählte, prominente sozialwissenschaftliche Theorien (etwa: Konstruktivismus, Modernisierungstheorie, Spieltheorie) zu einer von den Studierenden zu erbringenden Syntheseleistung im Sinne des forschenden Lernens.
	% Die meisten der Studierenden sind das erste Mal in Deutschland und wissen oft wenig über Geschichte und Institutionen etablierter Demokratien. GPC bietet hier eine kleine Landeskunde über die neue (Studien-)heimat der Studierenden und eine politische Bildung für die Gast- und manchmal zukünftigen Staatsbürger.
	% Das Seminar diskutiert zunächst die zivilisatorische Katastrophe der Shoah (etwa: Arendt, Bauer, Browning, Goldhagen), beschreibt dann die institutionellen Innovationen der BRD (etwa: Schmidt, Newton/van Deth, Grundgesetz) und notiert schließlich Wandel und Krise des deutschen Wohlfahrtsstaates und der europäischen Integration.
	% Die Begegnung mit sozialwissenschaftlichen Denkweisen ist den StudienanfängerInnen meist ebenfalls neu. GPC ergänzt daher die Landeskunde durch ausgewählte, einschlägige Literatur, um mit den Studierenden über die Irr- und Sonderwege deutscher Geschichte zu abstrahieren und herauszuarbeiten, welche Aspekte sich auf (post-)industrielle Gesellschaft verallgemeinern lassen und welche davon spezifisch deutsche Erfahrungen sein könnten.

	% Die Studierenden sind durch ihre bisherigen Bildungswege häufig an frontale und geschlossene Unterrichtsformen gewöhnt, weshalb selbständige, quellengeleitete Erörterungen eine große Herausforderung für sie darstellen. Daher begleitet GPC die Studierenden dabei, selbständige Syntheseleistungen zu offenen Fragen in 2-3 Essays zu verschriftlichen (etwa: “Ist der Tod ein Meister aus Deutschland?”).
	% Die Studierenden sind aufgerufen, ihre kritische Antwort sowohl in der theoretischen Literatur als auch anhand der deutschen historischen Evidenz zu verorten und einer theorie- und datengeleiteten Forschung zu folgen. Der eingebettete Kurs APS bietet den Studierenden das methodische Rüstzeug zum akademischen, quellengeleiteten Schreiben.

	% Darüber hinaus fordert das Kurswiki (https://sites.google.com/site/gpcfy2012/) Studierende zu Interaktion und kooperativem Lernen auf. Kleine Aufgaben (etwa: zentrale Begriffe definieren, Sitzungen zusammenfassen, Illustrationen erarbeiten, Lesefragen beantworten) zerteilen die Inhalte auf “Häppchengrößen”.
	% Besonders die zu allen theoretischen Texten bereitgestellten und online diskutierten Lesefragen helfen den Studierenden beim Erschließen von komplexen Texten.
	% Darüber hinaus bietet das Wiki ein flexibles Forum, um auf unterschiedliche Persönlichkeiten und Lernstile der Studierenden einzugehen und es ergänzt das Seminargeschehen motivationsfördernd durch Videos, Darstellungen und schriftliche Zusammenfassungen.
	% Das Wiki ermöglicht den oft ausländischen Studierenden, denen die mündliche Mitarbeit in englischer Sprache zum Teil schwer fällt, auf andere Weise aktiv, das heißt online, zum Seminar beizutragen. Letztlich trainiert das Kurswiki die Studierenden im Umgang mit zeitgemäßer Arbeitstechniken für IKT-basierte Zusammenarbeit.
	% Im Wiki finden sich zudem weiterführende Verweise zu Podcasts, Internetseiten, Videos und anderen Materialien.
	% Auch im Seminar werden unterschiedliche Lernstile und Wahrnehmungskanäle bedient: Zum Unterrichtsgespräch werden umfangreiche Visualisierungen und Notizen auf selbsthaftenden Folien erstellt, die nach dem Seminar an die Wand geheftet werden und das ganze Semester dort verbleiben.
	% Die Seminarinhalte werden auf diese Weise nach und nach von den Studierenden und mir im Raum entworfen, so dass jedes Thema, Konzept und Theorie einen definitiven physischen Ort im Seminar hat (etwa: links über der Tür). Dies erleichtert spätere Rückgriffe und Verbindungen und unterstützt die Verstetigung des Seminars.
